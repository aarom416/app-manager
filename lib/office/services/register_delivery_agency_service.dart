...
class RegisterDeliveryAgencyService {
  final Ref ref;

  RegisterDeliveryAgencyService(this.ref);
...
final registerDeliveryAgencyServiceProvider =
    Provider<RegisterDeliveryAgencyService>(
        (ref) => RegisterDeliveryAgencyService(ref));
