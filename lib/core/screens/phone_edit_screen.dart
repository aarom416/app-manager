...
class PhoneEditScreen extends StatefulWidget {
  ...
  @override
  State<PhoneEditScreen> createState() => _PhoneEditScreen();
}

class _PhoneEditScreen extends State<PhoneEditScreen> {
  late String value;
    ...
    return Scaffold(
      ...
      body: SGContainer(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            SGTypography.body("본인명의 휴대폰이 없는 경우, 싱그릿 고객센터 1600-7723 로 연락해주세요.", color: SGColors.gray4, size: FontSize.small, weight: FontWeight.w400),
          ])),
    );
  }
}
