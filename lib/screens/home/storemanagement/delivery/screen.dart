...
class _DeliveryScreenState extends ConsumerState<DeliveryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final DeliveryNotifier provider =
          ...
          children: [
            ...
            MultipleInformationBox(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                SGTypography.body(
                    "${state.minDeliveryTime} ~ ${state.maxDeliveryTime}분",
            ...
            MultipleInformationBox(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => TakeOutTimeScreen(
                                    ...
                                    onSaveFunction:
                                        (minTakeOutTime, maxTakeOutTime) {
                                      // print("onSaveFunction $minTakeOutTime $maxTakeOutTime");
                                      provider.updatePickupTime(
                                          minTakeOutTime, maxTakeOutTime);
                                    },
                                  )));
                        },
                ...
                SGTypography.body(
                    "${state.minTakeOutTime} ~ ${state.maxTakeOutTime}분",
                    color: SGColors.gray4,
                    size: FontSize.normal)
              ])
            ]),
            ...
            SGContainer(
                ...
                child: Column(
                    ...
                    children: [
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => DeliveryTipScreen(
                                    ...
                                    storeDeliveryTipDTOList:
                                        state.storeDeliveryTipDTOList,
                                    deliveryTipInfo:
                                        state.deliveryDataModel.deliveryTipInfo,
                                    onSaveFunction: (baseDeliveryTip,
                                        minimumOrderPrice,
                                        storeDeliveryTipDTOList) {
                                      // print("onSaveFunction $baseDeliveryTip $minimumOrderPrice $storeDeliveryTipDTOList");
                                      provider.updateDeliveryTip(
                                          baseDeliveryTip,
                                          minimumOrderPrice,
                                          storeDeliveryTipDTOList);
                                    },
                      ...
                      SGTypography.body("최소 주문 금액",
                          color: SGColors.gray4, weight: FontWeight.w600),
                      SizedBox(height: SGSpacing.p5 / 2),
                      Table(
                          border: TableBorder.all(
                              color: SGColors.line2,
                              borderRadius:
                          ...
                          children: [
                              ...
                              Center(
                                  child: SGContainer(
                                      padding: EdgeInsets.all(
                                          SGSpacing.p3 + SGSpacing.p05),
                                      child: SGTypography.body("주문 금액",
                                          color: SGColors.black,
                            ...
                            ...state.storeDeliveryTipDTOList
                                .map((deliveryTipModel) => TableRow(children: [
                                      Center(
                                          child: SGContainer(
                                              padding: EdgeInsets.all(
                                                  SGSpacing.p3 + SGSpacing.p05),
                                              child: SGTypography.body(
                                                  "${deliveryTipModel.minPrice.toKoreanCurrency}원",
                                                  color: SGColors.black,
                                                  weight: FontWeight.w700))),
                                      Center(
                                          child: SGContainer(
                                              padding: EdgeInsets.all(
                                                  SGSpacing.p3 + SGSpacing.p05),
                                              child: SGTypography.body(
                                                  "${deliveryTipModel.deliveryTip.toKoreanCurrency}원",
                                                  color: SGColors.gray5,
                                                  weight: FontWeight.w500))),
                                    ])),
                            // ]
                                      ...
                                      Center(
                                          child: SGContainer(
                                              padding: EdgeInsets.all(
                                                  SGSpacing.p3 + SGSpacing.p05),
                                              child: SGTypography.body(
                                                  "${deliveryTipModel.minPrice.toKoreanCurrency}원 ~ ${deliveryTipModel.maxPrice.toKoreanCurrency}원",
                                                  color: SGColors.black,
                                                  weight: FontWeight.w700))),
                                      Center(
                                          child: SGContainer(
