...
class DeliveryService {
   ...
   */
  Future<Response<dynamic>> updateDeliveryTip({required String storeId, required int baseDeliveryTip, required int minimumOrderPrice, required List<DeliveryTipModel> storeDeliveryTipDTOList}) async {
    try {
      return await ref.read(requestApiProvider).post(
        RestApiUri.updatePickupTime,
        data: {
