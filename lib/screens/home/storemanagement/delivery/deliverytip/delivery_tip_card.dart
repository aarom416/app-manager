              ...
              Expanded(
                child: SGTextFieldWrapper(
                  ...
                  children: [
                    ...
                    SGContainer(padding: EdgeInsets.symmetric(horizontal: SGSpacing.p3), child: SGTypography.body("원 이상", color: SGColors.gray4, size: FontSize.small, weight: FontWeight.w500)),
                  ],
                )),
              ),
              ...
              Expanded(
                child: SGTextFieldWrapper(
                  ...
                  children: [
                    ...
                    SGContainer(padding: EdgeInsets.symmetric(horizontal: SGSpacing.p3), child: SGTypography.body("원 미만", color: SGColors.gray4, size: FontSize.small, weight: FontWeight.w500)),
                  ],
                )),
              ),
              SizedBox(width: SGSpacing.p2),
