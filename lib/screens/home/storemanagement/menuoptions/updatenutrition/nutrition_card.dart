        ...
        child: Column(children: [
          ...
          SGContainer(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                SGTypography.body("${nutrition.calories}Kcal", size: FontSize.large, weight: FontWeight.w700, color: SGColors.primary),
              ])),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            SGTypography.body("${nutrition.servingAmount}${nutrition.servingAmountType}", size: FontSize.normal, weight: FontWeight.w500, color: SGColors.gray5)
          ]),
          ...
          SGContainer(
              ...
              child: Row(children: [
                ...
                SGContainer(width: 1, height: SGSpacing.p8, color: SGColors.line1),
                Expanded(child: Column(children: [SGTypography.body("나트륨", size: FontSize.small, color: SGColors.gray5), SizedBox(height: SGSpacing.p1), SGTypography.body("${nutrition.natrium} mg", size: FontSize.normal, color: SGColors.gray5)])),
              ]))
        ]));
  }
}
