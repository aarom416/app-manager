        ...
        body: SGContainer(
          ...
          child: ListView(children: [
                ...
                child: Column(children: [
                  Row(children: [
                            ...
                            children: [
                              ...
                              if (menuModel.soldOutStatus == 1)
                                Container(
                                  ...
                                  height: SGSpacing.p20,
                                  color:
                                      const Color(0xFF808080).withOpacity(0.7),
                                  child: const Center(
                                    child: Text(
                                      "품절",
                                      style: TextStyle(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ImageUploadScreen(
                                  ...
                                  onSubmit: (List<String> imagePaths) {
                                    ...
                                    provider.adminUpdateMenuPicture(
                                        widget.menuModel.menuId, imagePaths[0]);
                                  },
                                ),
                              ),
                            );
                    ...
                    Column(
                      ...
                      children: [
                        SGTypography.body(menuModel.menuName,
                            size: FontSize.medium, weight: FontWeight.w700),
                        SizedBox(height: SGSpacing.p2),
                        SGTypography.body(
                            "${menuModel.price.toKoreanCurrency}원",
                            size: FontSize.small,
                  ...
                  Row(children: [
                    ...
                    Expanded(
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => TextFieldEditScreen(
                                  ...
                                  onSubmit: (value) {
                                    provider
                                        .updateMenuName(
                                            widget.menuModel.menuId, value)
                                        .then((success) {
                                      logger.d(
                                          "updateMenuName success $success $value");
                                      if (success) {
                                        setState(() {
                                          menuModel = menuModel.copyWith(
                                              menuName: value);
                                        });
                                        showGlobalSnackBar(
                                            context, "성공적으로 변경되었습니다.");
                                      }
                                    });
                                  },
                                )));
                      ...
                      child: SGContainer(
                        ...
                        child: Center(
                            child: SGTypography.body("메뉴명 변경",
                                size: FontSize.small,
                                weight: FontWeight.w400,
                                color: SGColors.gray4)),
                      ),
                            ...
                            builder: (context) => TextFieldEditScreen(
                                  ...
                                  onSubmit: (value) {
                                    ...
                                    if (price != null) {
                                      provider
                                          .updateMenuPrice(
                                              widget.menuModel.menuId, price)
                                          .then((success) {
                                        logger.d(
                                            "updateMenuPrice success $success $value");
                                        if (success) {
                                          setState(() {
                                            menuModel = menuModel.copyWith(
                                                price: price);
                          ...
                          onChanged: (value) {
                            provider
                                .updateMenuSoldOutStatus(
                                    widget.menuModel.menuId, value ? 1 : 0)
                                .then((success) {
                              logger.d(
                                  "updateMenuSoldOutStatus success $success $value");
                              if (success) {
                                setState(() {
                                  menuModel = menuModel.copyWith(
                      ...
                      SGSwitch(
                          ...
                          onChanged: (value) {
                            provider
                                ...
                                .then((success) {
                              logger.d(
                                  "updateMenuPopularity success $success $value");
                              if (success) {
                                setState(() {
                                  menuModel = menuModel.copyWith(
                                      popularityStatus: value ? 1 : 0);
                                });
                              }
                            });
                          }),
                      ...
                      SGSwitch(
                          ...
                          onChanged: (value) {
                            provider
                                ...
                                .then((success) {
                              logger.d(
                                  "updateMenuBestStatus success $success $value");
                              if (success) {
                                setState(() {
                                  menuModel = menuModel.copyWith(
                                      bestStatus: value ? 1 : 0);
                                });
                              }
                            });
                          }),
            ...
            SGContainer(
                color: const Color(0xFFFAFAFA),
                padding:
                    EdgeInsets.all(SGSpacing.p4).copyWith(bottom: SGSpacing.p5),
                child: Column(children: [
                  // --------------------------- 메뉴 구성 ---------------------------
                  MultipleInformationBox(children: [
                            ...
                            builder: (context) => TextareaEditScreen(
                                  ...
                                  onSubmit: (value) {
                                    provider
                                        ...
                                        .then((success) {
                                      logger.d(
                                          "updateMenuMadeOf success $success $value");
                                      if (success) {
                                        setState(() {
                                          menuModel = menuModel.copyWith(
                                              menuParts: value);
                    ...
                    SGTypography.body(menuModel.menuParts,
                  ...
                  MultipleInformationBox(children: [
                            ...
                            builder: (context) => TextareaEditScreen(
                                  ...
                                  onSubmit: (value) {
                                    provider
                                        ...
                                        .then((success) {
                                      logger.d(
                                          "updateMenuIntroduction success $success $value");
                                      if (success) {
                                        setState(() {
                                          menuModel = menuModel.copyWith(
                    ...
                    SizedBox(height: SGSpacing.p5),
                    SGTypography.body(menuModel.menuDescription,
                        size: FontSize.small,
                        weight: FontWeight.w500,
                        lineHeight: 1.25),
                  ]),
                      ...
                      NutritionCard(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(screenContext).push(MaterialPageRoute(
                              builder: (nutritionScreenContext) =>
            ...
            SGContainer(
                color: const Color(0xFFFAFAFA),
                padding:
                    EdgeInsets.all(SGSpacing.p4).copyWith(top: SGSpacing.p5),
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      SGActionButton(
                                    ...
                                    Row(children: [
                                      Expanded(
                                        child: GestureDetector(
                                          onTap: () {
                                            provider
                                                .deleteMenu(widget.menuModel)
                                                .then((success) {
                                              logger.d(
                                                  "updateMenuIntroduction success $success");
                                              if (success) {
