      ...
      body: PageView(
          ...
          children: [
            ...
            _Page_4_MenuRegistration(
              ...
              onEditFunction: (imagePath, menuBriefDescription,
                  menuIntroduction, selectedMenuOptionCategories) {
                logger.d(
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        selectedUserMenuCategories.sort(
                          (a, b) => userMenuCategories
                              .indexOf(a)
                              .compareTo(userMenuCategories.indexOf(b)),
                        );
                      });
                    },
                    child: __CategoryOptionRadioButton(
        ...
        child: ListView(
          children: [
            ...
            MultipleInformationBox(children: [
              ...
              SizedBox(height: SGSpacing.p5),
              SGTypography.body(menuIntroduction,
                  size: FontSize.small,
                  weight: FontWeight.w500,
                  lineHeight: 1.25),
            ]),
