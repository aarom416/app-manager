              ...
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => StoreHolidayScreen(
                      ...
                      onSaveFunction: (holidayStatus, holidayDetails) {
                        print("onSaveFunction holidayStatus $holidayStatus");
                        print("onSaveFunction holidayDetails $holidayDetails");
                        // provider.updateBreakTime(breakTimeDetails);
                        // Navigator.of(context).pop();
                      }),
                ));
...
class __NonBusinessHourConfigurationScreenState extends State<_NonBusinessHourConfigurationScreen> {
  List<NonBusinessHourModel> nonBusinessHours = [
    NonBusinessHourModel(id: 1, weekday: "월요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 2, weekday: "화요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 3, weekday: "수요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 4, weekday: "목요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 5, weekday: "금요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 6, weekday: "토요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
    NonBusinessHourModel(id: 7, weekday: "일요일", startHour: "오전 10시", startMinute: "00분", endHour: "오후 10시", endMinute: "00분", isAvailable: true),
  ];
                    ...
                    return [
                      __NonBusinessHourConfigurationCard(
                        ...
                        onEdit: (nonBusinessHour) {
                          setState(() {
                            nonBusinessHours = nonBusinessHours.map((nbh) => nbh.id == nonBusinessHour.id ? nonBusinessHour : nbh).toList();
                          });
                        },
                      ),
                      SizedBox(height: SGSpacing.p2 + SGSpacing.p05)
                ...
                child: GestureDetector(
                  ...
                  child: SGTextFieldWrapper(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      SGTypography.body(nonBusinessHour.startHour, color: SGColors.black, size: FontSize.normal, weight: FontWeight.w500),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: SGTextFieldWrapper(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: SGSpacing.p4, vertical: SGSpacing.p3),
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      SGTypography.body(nonBusinessHour.startMinute, color: SGColors.black, size: FontSize.normal, weight: FontWeight.w500),
                      Image.asset('assets/images/dropdown-arrow.png', width: 16, height: 16),
                    ]),
                  )),
                ),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: SGTextFieldWrapper(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: SGSpacing.p4, vertical: SGSpacing.p3),
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      SGTypography.body(nonBusinessHour.endHour, color: SGColors.black, size: FontSize.normal, weight: FontWeight.w500),
                      Image.asset('assets/images/dropdown-arrow.png', width: 16, height: 16),
                    ]),
                  )),
                ),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: SGTextFieldWrapper(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: SGSpacing.p4, vertical: SGSpacing.p3),
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      SGTypography.body(nonBusinessHour.endMinute, color: SGColors.black, size: FontSize.normal, weight: FontWeight.w500),
                      Image.asset('assets/images/dropdown-arrow.png', width: 16, height: 16),
                    ]),
                  )),
                ),
