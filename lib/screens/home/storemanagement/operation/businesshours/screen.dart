...
class StoreOperationTimesScreen extends StatefulWidget {
  ...
  const StoreOperationTimesScreen(
      {super.key,
      required this.operationTimeDetails,
      required this.onSaveFunction});

  @override
  State<StoreOperationTimesScreen> createState() =>
      _StoreOperationTimesScreenState();
}
          ...
          Row(
            ...
            children: [
              ...
              SGTypography.body("24시",
                  ...
                  color: is24Hour ? SGColors.primary : SGColors.gray4),
              SizedBox(width: SGSpacing.p1),
              SGSwitch(
                value: is24Hour,
                onChanged: (value) {
                  onEditFunction(businessHour.copyWith(
                      startTime: value ? "00:00" : "09:00",
                      endTime: value ? "24:00" : "21:00"));
                },
              ),
            ],
          ),
