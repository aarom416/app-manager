...
class SendEmailScreen extends StatelessWidget {
  final TextEditingController emailController = TextEditingController(text: "singleat@singleat.com");
                  ...
                  SGActionButton(
                      onPressed: () {
                        showSGDialog(
                            ...
                            childrenBuilder: (ctx) => [
                                  Center(
                                    child: SGTypography.body("사장님의 이메일로\n전송해드리겠습니다.",
                                  ...
                                  SGTypography.body("받는사람: ${emailController.text}",
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: SGSpacing.p2 + SGSpacing.p05),
                                      Expanded(
                                        child: GestureDetector(
                                          onTap: () {
                                            Navigator.of(ctx).pop();
